...
export const ABOUT_CONTENT = {
  "zh-CN": {
    ...
    features: ["课程表：查看并管理24级、25级与自己的课程安排", "学习知识库：按课程整理记录、资料、知识与时间线", "DeepSeek AI 学习整理：为纯文字学习记录生成摘要、知识点与复习建议", "日语学习：按教材与课次整理单词和语法，支持逐词发音、个人笔记与 AI 辅助知识整理", "聊天与待办：处理日常交流、提醒和学习任务", "个人设置：管理身份、主题、课表、作息与本地数据"],
    creationTitle: "创作方式",
  ...
  "ja-JP": {
    ...
    features: ["時間割：24年・25年と自分の授業予定を確認・管理", "学習ナレッジ：授業ごとに記録・資料・知識・タイムラインを整理", "DeepSeek AI 学習整理：テキスト記録から要約・ポイント・復習提案を作成", "日本語学習：教材と課ごとに単語・文法を整理し、単語ごとの発音・自分のメモ・AI補助整理に対応", "チャットとToDo：日々の交流・連絡・学習タスクを管理", "個人設定：プロフィール・テーマ・時間割・授業時間・端末データを管理"],
