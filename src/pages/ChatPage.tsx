...
export function ChatPage({ onlineUsers, onUnreadHandled }: { onlineUsers: PresenceUser[]; onUnreadHandled: () => void }) {
  ...
  const selectConversation = (conversation: PrivateConversation) => {
    setPrivateTarget({ id: conversation.userId, username: conversation.username, avatarUrl: null, role: conversation.role, cohortYear: conversation.cohortYear, createdAt: "" })
    setMode("private")
  }
