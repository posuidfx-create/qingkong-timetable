...
describe("changelog", () => {
  ...
  it("documents the mobile cohort chat room entry fix", () => expect(changelog[0].changes.some((change) => change.text.includes("手机端聊天室") || change.text.includes("移动端年级聊天室"))).toBe(true))
})
