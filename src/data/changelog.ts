...
export const changelog: readonly ChangelogEntry[] = [
  { version: APP_VERSION, title: "响应式与交互精修", description: "让晴空课表在手机、平板和电脑上都更加自然好用。", isCurrent: true, changes: [...changes(["管理员待办支持上传图片与学习资料附件", "待办附件支持预览图片与安全下载", "编辑管理员待办时可保留、添加或移除附件"], "new"), ...changes(["优化平板与桌面端响应式布局", "桌面端不再局限于手机宽度", "优化桌面课程表显示空间", "优化聊天桌面双栏布局", "精修聊天消息气泡、头像与消息间距", "优化聊天输入框和消息滚动体验", "优化私聊桌面会话体验", "优化 Todo 桌面布局与发布入口", "优化“我的”页面桌面布局", "统一移动端与桌面端导航体验", "优化自动登录后的认证状态同步"], "improved"), ...changes(["修复部分登录状态下管理员操作仍可能提示权限不足的问题", "优化待办附件发布失败提示与清理流程"], "fixed")] },
